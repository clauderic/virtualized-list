...
describe('SizeAndPositionManager', () => {
  ...
  describe('getTotalSize', () => {
    it(
      'should calculate total size based purely on :estimatedItemSize if no measurements have been done',
      () => {
        const {sizeAndPositionManager} = getItemSizeAndPositionManager();
    ...
    it(
      'should calculate total size based on a mixture of actual item sizes and :estimatedItemSize if some items have been measured',
      () => {
        const {sizeAndPositionManager} = getItemSizeAndPositionManager();
  ...
  describe('getUpdatedOffsetForIndex', () => {
    ...
    it(
      'should not scroll past the safe bounds even if the specified :align requests it',
      () => {
        expect(
          getUpdatedOffsetForIndexHelper({
            align: 'end',
